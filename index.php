        ...
        <div class="container">         
            <div class="row">
                ...
                <form name="forma" id="forma" action="php/datos.php" method="post" class="row g-3">
                    ...
                    <div class="col-md-4">
                         <label for="id_mail" class="form-label">Correo electrónico:</label>
                    ...
                    <div class="col-md-4">
                        <label for="xDiscapacidad" class="form-label">¿Padeces alguna condición de salud especial?</label>
                    ...
                    <div id="divLenguaIndigena" class="col-md-4 ">
                        ...
                        <select name="xLenguaIndigena" id="xLenguaIndigena" class="form-select">
                            ...
                            <option value="19">Otomí</option>
                            
                            <option value="20">Popoluca</option>
                            
                            <option value="21">Purépecha</option>
                    ...
                    <div class="col-md-14">
                        <label for="xCalle" class="form-label">Calle - Número:</label> 
                    ...
                    <hr>
                    <h1 class="display-5 text-center">Elección de la carrera de TSU</h1>                    
                    <div class="col-md-6">                        
                    ...
                    <h3 class="display-5 text-center">Elección de la carrera de TSU (2° opción)</h3>                    
                    <div class="col-md-6">                        
                    ...
                    <h1 class="display-5 text-center">¿Por qué medio te enteraste de la UTP?</h1> 
